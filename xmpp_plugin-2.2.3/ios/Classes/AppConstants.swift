...
struct pluginMethod {
    ...
    static let getMyMUCs : String                   = "get_my_mucs"
    ...
    static let dropRosters : String                 = "drop_roster"
    static let getMyRosters : String                = "get_my_rosters"
    static let getVCard : String                    = "get_vcard"
    static let saveVCard : String                   = "save_vcard"
